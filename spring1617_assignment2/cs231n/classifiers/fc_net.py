    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers):
            ...
            if i != (self.num_layers - 1):
                if self.use_batchnorm:
                    out[i + 1], cache[i + 1] = affine_batchnorm_relu_forward(out[i], self.params['W' + str(i + 1)],
        ...
        for i in range(self.num_layers - 1, -1, -1):
            ...
            if i == (self.num_layers - 1):
                ...
                if self.use_batchnorm:
                    ...
                    grads['gamma' + str(i + 1)], grads['beta' + str(i + 1)] = affine_batchnorm_relu_backward(
                        dout[i + 1], cache[i + 1])
                else:
                    dout[i], grads['W' + str(i + 1)], grads['b' + str(i + 1)] = affine_relu_backward(dout[i + 1],
                                                                                                     cache[i + 1])
